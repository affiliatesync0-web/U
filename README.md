...
Para que los correos de restablecimiento de contraseña salgan desde tu Gmail personalizado, debes configurar el servidor SMTP manualmente en Firebase:
1. Ve a la **Consola de Firebase** -> **Authentication** -> **Templates**.
