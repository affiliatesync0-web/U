...
export default function AffiliateProductsPage() {
  const products = [
    { id: "P-101", name: "Excel Mastery Course", type: "Course", price: "$49.99", commission: "20%", code: "EXCEL24", imageId: "product-education" },
    { id: "P-102", name: "SEO Optimization Service", type: "Service", price: "$199.00", commission: "15%", code: "SEO-OPT", imageId: "product-tech" },
    { id: "P-103", name: "Modern Cookery Ebook", type: "Infoproduct", price: "$12.50", commission: "40%", code: "COOK2024", imageId: "product-service" },
    { id: "P-104", name: "Personalized Coaching", type: "Service", price: "$75.00", commission: "25%", code: "COACH-X", imageId: "product-analytics" },
    { id: "P-105", name: "Digital Art Pack", type: "Digital Product", price: "$29.00", commission: "30%", code: "ART-PK", imageId: "product-code" },
  ]
