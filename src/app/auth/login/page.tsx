        ...
        <div className="bg-slate-50/50 rounded-[3rem] p-8 md:p-12">
          ...
          <CardContent className="p-0 space-y-6">
            <Button 
              ...
              className="w-full h-14 rounded-2xl border-slate-200 bg-white hover:bg-slate-50 font-black text-[10px] uppercase tracking-widest gap-3 shadow-sm transition-all"
              disabled={loading}
            >
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="h-12 rounded-xl bg-white" placeholder="tu@correo.com" />
              </div>
              <div className="space-y-2">
                <Label className="font-black text-[10px] uppercase tracking-widest text-slate-500 ml-1">Contraseña</Label>
                <div className="relative">
                  <Input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} required className="h-12 rounded-xl bg-white" placeholder="••••••••" />
              ...
              <Button type="submit" className="w-full h-14 rounded-2xl font-black text-lg shadow-xl shadow-primary/20 transition-all hover:scale-[1.02]" disabled={loading}>
          ...
          <CardFooter className="justify-center mt-10 p-0 flex flex-col gap-2">
            ...
            <Link href="/auth/admin-login" className="text-[9px] font-black uppercase text-slate-300 hover:text-slate-500 tracking-widest">Acceso Admin</Link>
          </CardFooter>
        </div>
      </Card>
    </div>
