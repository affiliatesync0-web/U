...
function RegisterContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // El Shell se encargará de llevarlo al dashboard correcto al detectar el cambio de auth
    } catch (error: any) {
      ...
      {step === 'role' && (
        <div className="w-full max-w-4xl space-y-10 animate-in fade-in zoom-in-95 duration-500">
          <div className="text-center">
            <h1 className="text-5xl font-headline font-black text-slate-900 tracking-tight">Crea tu Cuenta</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-sm font-medium text-slate-400 leading-relaxed">Accede a formación y herramientas digitales exclusivas.</p>
            </button>
            <button 
            ...
            >
              ...
              <p className="text-sm font-medium text-slate-400 leading-relaxed">Únete a nuestra red, recomienda productos y genera ingresos.</p>
            </button>
          </div>
        </div>
      )}
      ...
      {step === 'info' && (
        <Card className="w-full max-w-xl border-none shadow-2xl rounded-[3.5rem] p-10 md:p-14 animate-in slide-in-from-bottom-8 duration-500">
          <div className="space-y-10">
            ...
            <div className="relative"><div className="absolute inset-0 flex items-center"><span className="w-full border-t" /></div><div className="relative flex justify-center text-[9px] uppercase font-black text-slate-400"><span className="bg-white px-3">O con Email</span></div></div>
            ...
            <form onSubmit={role === 'affiliate' ? (e) => { e.preventDefault(); setStep('exam'); } : handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label className="text-[9px] font-black uppercase tracking-widest text-slate-400 ml-1">WhatsApp <span className="text-primary">*</span></Label>
      ...
      {step === 'exam' && (
        <Card className="w-full max-w-xl border-none shadow-2xl rounded-[3.5rem] p-10 md:p-14 animate-in slide-in-from-right-8 duration-500">
          <CardHeader className="p-0 mb-10">
            ...
            <p className="text-sm font-medium text-slate-400 mt-2">Queremos conocer tu estrategia antes de activar tu cuenta.</p>
          </CardHeader>
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="p-6 bg-blue-50 border border-blue-100 rounded-[2rem] flex items-start gap-4">
               ...
               <p className="text-[10px] font-bold text-blue-700 leading-relaxed">
                 Tu solicitud será revisada. Recibirás un correo cuando tu panel de ventas sea habilitado.
               </p>
            </div>
