...
function RegisterSelectionContent() {
  ...
  return (
    <div className="min-h-screen bg-white md:bg-[#EAEDED] flex flex-col items-center pt-8 pb-12">
      ...
      <div className="w-full max-w-[350px] bg-white border border-[#ddd] shadow-none md:shadow-sm rounded-[4px] p-8 space-y-6">
        <h1 className="text-[28px] font-normal text-[#111] leading-tight text-left">Crear cuenta</h1>
        
        <p className="text-[13px] text-[#111] font-bold">Selecciona tu objetivo principal:</p>
        ...
        <div className="space-y-4">
          <Link href="/auth/register/buyer" className="group flex items-center justify-between p-4 border border-[#ddd] rounded-md hover:bg-[#f7fafa] hover:border-[#007185] transition-all">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-[13px] font-bold text-[#111]">Quiero comprar</h3>
                <p className="text-[11px] text-[#555]">Acceder a formación</p>
              </div>
            </div>
            <ChevronRight className="h-4 w-4 text-[#888] group-hover:text-[#111] transition-colors" />
          </Link>
          ...
          <Link href="/auth/register/affiliate" className="group flex items-center justify-between p-4 border border-[#ddd] rounded-md hover:bg-[#f7fafa] hover:border-[#007185] transition-all">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-[13px] font-bold text-[#111]">Quiero ser Embajador</h3>
                <p className="text-[11px] text-[#555]">Generar comisiones</p>
              </div>
            </div>
            <ChevronRight className="h-4 w-4 text-[#888] group-hover:text-[#111] transition-colors" />
          </Link>
        ...
        <div className="pt-6 border-t border-[#eee] text-center">
          <p className="text-[13px] text-[#111]">
            ¿Ya tienes una cuenta? <Link href="/auth/login" className="text-[#0066c0] hover:underline hover:text-[#c45500] font-bold">Iniciar sesión <ChevronRight className="inline h-3 w-3" /></Link>
          </p>
        </div>
      </div>
